\begin{algorithm}[!h]
\caption{Progressive fast-path and slow-path opaque HyTM implementation that provides uninstrumented writes and invisible reads; code for process $p_i$
executing slow-path transaction $T_k$}
\label{alg:inswrite}
\begin{algorithmic}[1]
  	\begin{multicols}{2}
  	{
