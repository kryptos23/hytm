...
validation cost that is \emph{linear} in the size of the transaction's read set. This is in stark contrast to progressive software TMs which can achieve $O(1)$ read complexity.
