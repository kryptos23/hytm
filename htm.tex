...
In fact, this lower bound holds even if hardware transactions may read metadata \emph{non-speculatively} (which intuitively reduces conflicts aborts due to metadata instrumentation).
