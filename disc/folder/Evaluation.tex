...
(G4) to determine whether direct accesses can be used to obtain performance improvements on IBM POWER8 using the supported suspend/resume isntruction to escape from a hardware transaction.
