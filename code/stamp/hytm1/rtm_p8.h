...
#define X_ABORT_STATUS_IS_RETRY(arg) (!(__TM_is_failure_persistent((void*) (arg))))
#define X_ABORT_STATUS_IS_ILLEGAL(arg) (__TM_is_illegal((void*) (arg)))
#define X_ABORT_FAILURE_ADDRESS(arg) (__TM_failure_address((void*) (arg)))
