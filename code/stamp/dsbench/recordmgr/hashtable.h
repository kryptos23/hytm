...
#define EMPTY_CELL 0
    ...
    class hashset {
        ...
        public:
            hashset() {
                VERBOSE DS_DEBUG cout<<"constructor hashset"<<endl;
                cleared = false;
                clear();
            }
            ~hashset() {
                VERBOSE DS_DEBUG cout<<"destructor hashset"<<endl;
            }
            void clear() {
                if (!cleared) {
...
//        public:
//            AtomicHashSet() {
//                VERBOSE DS_DEBUG cout<<"constructor AtomicHashSet"<<endl;
//                cleared = false;
//                clear();
//            }
//            ~AtomicHashSet() {
//                VERBOSE DS_DEBUG cout<<"destructor AtomicHashSet"<<endl;
//            }
//            void clear() {
//                if (!cleared) {
//                    memset(keys, EMPTY_CELL, TABLE_SIZE*sizeof(K*));
...
//    } __attribute__ ((aligned(BYTES_IN_CACHE_LINE)));
    ...
    public:
        hashset_new(const int numberOfElements) {
            ...
            VERBOSE DS_DEBUG cout<<"constructor hashset_new capacity="<<tableSize<<endl;
            keys = new K*[tableSize];
            __size = -1;
            clear();
        }
        ~hashset_new() {
//            VERBOSE DS_DEBUG cout<<"destructor hashset_new"<<endl;
            delete[] keys;
        }
        void clear() {
            if (__size) {
